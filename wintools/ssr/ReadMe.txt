    ...
    Version 2.5: July 10, 2013
      - Added validation for out of order progam options.

    Version 2.4: March 11, 2013
      - Added support for console input and output streams. 

    Version 2.3: July 3, 2012
      - Fixed bug with ignore case option. 
